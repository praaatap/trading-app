...
const SignUpPage: FC = () => {
  ...
  const settingAuthStatus = (status: boolean) => {
    if (status) {
          ...
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:flex flex-col space-y-8">
              {[
                {
                  icon: (
                    <ZapIcon className="w-8 h-8 mr-4 text-amber-400 mt-1" />
                  ),
                ...
                {
                  icon: (
                    <BarChartIcon className="w-8 h-8 mr-4 text-amber-400 mt-1" />
                  ),
                ...
                {
                  icon: (
                    <ShieldCheckIcon className="w-8 h-8 mr-4 text-amber-400 mt-1" />
                  ),
